...
const Navbar = (props: NavbarProps) => {
  ...
  const renderConnector = () => {
    return active ? (
      <button className={'btn-primary btn-default rounded-xl'}>{shortenAddress(account)}</button>
    ) : (
        ...
        <nav className="border-gray-200 dark:bg-gray-900 dark:border-gray-700">
          <div className=" flex flex-wrap items-center justify-between mx-0">
            ...
            <div className="hidden w-full md:block md:w-auto" id="navbar-dropdown">
              <ul className="flex flex-col p-4 pr-0 mt-4 border border-gray-100 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0">
                {/*<li>*/}
                {/*  <a href="#"*/}
